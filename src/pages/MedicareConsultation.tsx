...
const getIconComponent = (iconType: string) => {
  ...
  switch (iconType) {
    ...
    case 'file-text':
      return <Heart {...iconProps} style={{ color: '#4f46e5' }} />;
    default:
      return <Heart {...iconProps} style={{ color: '#2563eb' }} />;
  }
};
...
const MedicareConsultationPage = () => {
  const navigate = useNavigate();

  // Get the medicare consultation service data
  const service = servicesData.find(s => s.id === 'medicare-consultation');
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Medicare Consultation</h1>
            <div></div>
          </div>
        </div>
      </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                {service.pricing && (
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700"><strong>Pricing:</strong> {service.pricing}</span>
                  </div>
                )}
                {service.duration && (
                  <div className="flex items-center">
...
export default MedicareConsultationPage;
