...
const HealthInsurancePlansPage = () => {
  const navigate = useNavigate();

  // Get the health insurance service data
  const service = servicesData.find(s => s.id === 'health-insurance');
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Health Insurance Plans</h1>
            <div></div>
          </div>
        </div>
      </div>
...
export default HealthInsurancePlansPage;